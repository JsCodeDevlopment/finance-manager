...
import { Filter, Import, Plus, ReceiptText, Sparkles } from "lucide-react";
            ...
            <div className="relative z-10">
              ...
              <div className="mt-10 pt-8 border-t border-white/5 flex items-center gap-3 text-slate-500">
                ...
                <p className="text-[9px] font-bold uppercase tracking-[0.2em] leading-none">
                  Rastreamento de ativos e passivos
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="xl:col-span-8">
          <div className="flex items-center justify-between mb-10 px-4">
            <h3 className="text-xl font-bold text-white tracking-tight flex items-center gap-4">
              ...
              <span className="bg-white/5 text-slate-500 p-1.5 px-4 rounded-xl text-[10px] font-bold tracking-widest">
                {transactions.length}
              </span>
            </h3>
